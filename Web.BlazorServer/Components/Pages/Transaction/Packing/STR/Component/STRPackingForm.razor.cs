...
partial class STRPackingForm
{
    [Parameter]
    [EditorRequired]
    public StockTransferRequestInfoPackingVM Model { get; set; } = new();
    [Parameter]
    public Func<StockTransferRequestInfoPackingVM, Task<bool>>? OnSubmit { get; set; }
    [Parameter]
    ...
    AppTable<StockTransferRequestLinePackingVM> LinesTable = default!;
    ...
    async Task DeleteLine(StockTransferRequestLinePackingVM line)
    {
