...
public class VendorReturnAuthorizationItemReceiptPackingHandler(ISender sender) : IVendorReturnAuthorizationItemReceiptPackingHandler
{
    ...
    public async Task<bool> PostItemReceipt(VendorReturnAuthorizationItemReceiptPackingVM data)
    {
        var dto = MapToDto(data);
        return await sender.Send(new CreateItemReceiptCmd(dto));
    }

    private static VendorReturnAuthorizationItemReceiptPackingVM MapToVm(ItemReceiptDTO dto)
    {
        return new()
        {
            SourceType = dto.Type.ToLowerInvariant() switch
            {
                "trnfrord" => VendorReturnAuthorizationItemReceiptPackingVM.SourceTypes.TransferOrder,
                "purchord" => VendorReturnAuthorizationItemReceiptPackingVM.SourceTypes.PurchaseOrder,
                _ => VendorReturnAuthorizationItemReceiptPackingVM.SourceTypes.VendorReturnAuthorization
            },
    ...
    private static VendorReturnAuthorizationItemReceiptLinePackingVM MapToVm(ItemReceiptLineDTO dto)
    {
        return new()
        {
    ...
    private static ItemReceiptDTO MapToDto(VendorReturnAuthorizationItemReceiptPackingVM vm)
    {
        return new()
        {
            SourceType = vm.SourceType switch
            {
                VendorReturnAuthorizationItemReceiptPackingVM.SourceTypes.PurchaseOrder => ItemReceiptDTO.SourceTypes.PurchaseOrder,
                VendorReturnAuthorizationItemReceiptPackingVM.SourceTypes.VendorReturnAuthorization => ItemReceiptDTO.SourceTypes.Returns,
                VendorReturnAuthorizationItemReceiptPackingVM.SourceTypes.TransferOrder => ItemReceiptDTO.SourceTypes.TransferOrder,
    ...
    private static ItemReceiptLineDTO MapToDto(VendorReturnAuthorizationItemReceiptLinePackingVM vm)
    {
        return new()
        {
