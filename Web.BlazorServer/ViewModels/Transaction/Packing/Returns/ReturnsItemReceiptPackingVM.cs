...
public class ReturnsItemReceiptPackingVM
{
    ...
    public SourceTypes SourceType { get; set; } = SourceTypes.Returns;
    ...
    public List<ReturnsItemReceiptLinePackingVM> Lines { get; set; } = [];
}
