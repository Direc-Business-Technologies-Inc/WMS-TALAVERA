...
public partial class InventoryCountingView : IAsyncDisposable
{
    ...
    private List<InventoryCountingVM> FilteredData { get; set; } = [];
    ...
    protected override async Task OnInitializedAsync()
    {
        ActionGetInventoryCounting = new AppAction<List<InventoryCountingVM>>
        {
            ...
            TaskAsync = async () =>
            {
                ...
                var res = await Client.Get<List<InventoryCountingVM>>("/InventoryCounting/Started", new { NetsuiteUserSubsidiaryInternalId = UserSubsidiaryId });
                return res;
            },
    ...
    private static bool MatchesSearch(InventoryCountingVM row, string search)
    {
