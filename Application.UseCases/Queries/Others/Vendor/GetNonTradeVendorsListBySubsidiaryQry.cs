...
public record GetNonTradeVendorsListBySubsidiaryQry(DataGridIntent Intent, int subsidiaryId) : IRequest<(IEnumerable<VendorDTO> Data, int Count)>;

public class GetNonTradeVendorsListBySubsidiaryQryHandler(IVendorIntegration vendorIntegration)
